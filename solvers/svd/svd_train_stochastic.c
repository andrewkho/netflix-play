...
static const char __pyx_k_Reached_max_iters[] = "  Reached max iters!!!";
...
static PyObject *__pyx_kp_s_Reached_max_iters;
...
static PyObject *__pyx_pw_7solvers_3svd_20svd_train_stochastic_1svd_train_sgd(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("svd_train_sgd (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_right)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_resid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rand_order)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_uids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 4); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 5); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ratings)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 6); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rate)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 7); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_eps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 8); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_maxiters)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 9); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 10); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_include_bias)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, 11); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "svd_train_sgd") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_rand_order = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3]); if (unlikely(!__pyx_v_rand_order.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    ...
    __pyx_v_include_bias = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_include_bias == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("svd_train_sgd", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
...
/* "solvers/svd/svd_train_stochastic.pyx":16
 *     return _svd_train_sgd(left, right, resid, rand_order, uids, mids, ratings, rate, eps, maxiters, gamma, include_bias)
 * 
 * cdef float _svd_train_sgd(double[:,:] left, double[:,:] right, float[:] resid, int[:] rand_order,             # <<<<<<<<<<<<<<
 *                              int[:] uids, int[:] mids, double[:] ratings, double rate, double eps,
...
static float __pyx_f_7solvers_3svd_20svd_train_stochastic__svd_train_sgd(__Pyx_memviewslice __pyx_v_left, __Pyx_memviewslice __pyx_v_right, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_resid, __Pyx_memviewslice __pyx_v_rand_order, __Pyx_memviewslice __pyx_v_uids, __Pyx_memviewslice __pyx_v_mids, __Pyx_memviewslice __pyx_v_ratings, double __pyx_v_rate, double __pyx_v_eps, int __pyx_v_maxiters, double __pyx_v_gamma, int __pyx_v_include_bias) {
  ...
  __Pyx_RefNannySetupContext("_svd_train_sgd", 0);

  /* "solvers/svd/svd_train_stochastic.pyx":24
 ...
 */
  ...
  /* "solvers/svd/svd_train_stochastic.pyx":25
 * 
 *     old_resid = 0
 *     max_change = eps + 1             # <<<<<<<<<<<<<<
 *     for iter in range(maxiters):
 ...
 */
  ...
  /* "solvers/svd/svd_train_stochastic.pyx":26
 *     old_resid = 0
 *     max_change = eps + 1
 *     for iter in range(maxiters):             # <<<<<<<<<<<<<<
 *         max_change = 0
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "solvers/svd/svd_train_stochastic.pyx":37
 *             yhat = 0
 *             for k_ in range(left.shape[1]):
 *                 yhat += left[uid, k_] * right[mid, k_]             # <<<<<<<<<<<<<<
 *             err = rat - yhat
 ...
 */
        ...
        __pyx_t_14 = __pyx_v_k_;
        __pyx_v_yhat = (__pyx_v_yhat + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_left.data + __pyx_t_11 * __pyx_v_left.strides[0]) ) + __pyx_t_12 * __pyx_v_left.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right.data + __pyx_t_13 * __pyx_v_right.strides[0]) ) + __pyx_t_14 * __pyx_v_right.strides[1]) )))));
      }
 ...
 */
        __pyx_t_16 = __pyx_v_mid;
        __pyx_t_17 = __pyx_v_k;
        __pyx_t_18 = __pyx_v_uid;
        __pyx_t_19 = __pyx_v_k;
        __pyx_v_dleft = ((__pyx_v_err * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right.data + __pyx_t_16 * __pyx_v_right.strides[0]) ) + __pyx_t_17 * __pyx_v_right.strides[1]) )))) - (__pyx_v_gamma * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_left.data + __pyx_t_18 * __pyx_v_left.strides[0]) ) + __pyx_t_19 * __pyx_v_left.strides[1]) )))));

        /* "solvers/svd/svd_train_stochastic.pyx":43
 *             for k in range(left.shape[1]):
 *                 dleft = err * right[mid, k] - gamma * left[uid, k]  ## gamma controls regularization
 *                 dright = err * left[uid, k] - gamma * right[mid, k]             # <<<<<<<<<<<<<<
 *                 if include_bias and k == 0:
 *                     dleft = 0
 */
        __pyx_t_20 = __pyx_v_uid;
        __pyx_t_21 = __pyx_v_k;
        __pyx_t_22 = __pyx_v_mid;
        __pyx_t_23 = __pyx_v_k;
        __pyx_v_dright = ((__pyx_v_err * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_left.data + __pyx_t_20 * __pyx_v_left.strides[0]) ) + __pyx_t_21 * __pyx_v_left.strides[1]) )))) - (__pyx_v_gamma * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right.data + __pyx_t_22 * __pyx_v_right.strides[0]) ) + __pyx_t_23 * __pyx_v_right.strides[1]) )))));
 ...
 */
        __pyx_t_25 = (__pyx_v_include_bias != 0);
        if (__pyx_t_25) {
        } else {
          __pyx_t_24 = __pyx_t_25;
          goto __pyx_L12_bool_binop_done;
        }
        __pyx_t_25 = ((__pyx_v_k == 0) != 0);
        __pyx_t_24 = __pyx_t_25;
 ...
 */
        ...
        /* "solvers/svd/svd_train_stochastic.pyx":48
 *                 if include_bias and k == 1:
 *                     dright = 0
 *                 left[uid, k] += rate * dleft             # <<<<<<<<<<<<<<
 *                 right[mid, k] += rate * dright
 ...
 */
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_left.data + __pyx_t_26 * __pyx_v_left.strides[0]) ) + __pyx_t_27 * __pyx_v_left.strides[1]) )) += (__pyx_v_rate * __pyx_v_dleft);
 ...
 */
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right.data + __pyx_t_28 * __pyx_v_right.strides[0]) ) + __pyx_t_29 * __pyx_v_right.strides[1]) )) += (__pyx_v_rate * __pyx_v_dright);
 ...
 */
        __pyx_t_24 = (((((__pyx_v_rate * __pyx_v_rate) * __pyx_v_dleft) * __pyx_v_dleft) > __pyx_v_max_change) != 0);
        if (__pyx_t_24) {

          /* "solvers/svd/svd_train_stochastic.pyx":52
 * 
 *                 if rate*rate*dleft*dleft > max_change:
 *                     max_change = rate*rate*dleft*dleft             # <<<<<<<<<<<<<<
 *                 if rate*rate*dright*dright > max_change:
 ...
 * 
 */
        __pyx_t_24 = (((((__pyx_v_rate * __pyx_v_rate) * __pyx_v_dright) * __pyx_v_dright) > __pyx_v_max_change) != 0);
        if (__pyx_t_24) {
 ...
 */
    __pyx_t_24 = (((__pyx_v_iter % 20) == 0) != 0);
    if (__pyx_t_24) {
 ...
 *             break
 */
      __pyx_t_30 = PyFloat_FromDouble(__pyx_v_max_change); if (unlikely(!__pyx_t_30)) __PYX_ERR(0, 57, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_30);
      __pyx_t_31 = PyFloat_FromDouble(__pyx_v_eps); if (unlikely(!__pyx_t_31)) __PYX_ERR(0, 57, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_31);
      __pyx_t_32 = PyFloat_FromDouble(__pyx_v_total_err); if (unlikely(!__pyx_t_32)) __PYX_ERR(0, 57, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_32);
      __pyx_t_33 = PyTuple_New(3); if (unlikely(!__pyx_t_33)) __PYX_ERR(0, 57, __pyx_L1_error)
      ...
      __pyx_t_31 = 0;
      __pyx_t_32 = 0;
      __pyx_t_32 = __Pyx_PyString_Format(__pyx_kp_s_max_change_e_eps_e_resid_e, __pyx_t_33); if (unlikely(!__pyx_t_32)) __PYX_ERR(0, 57, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_32);
      __Pyx_DECREF(__pyx_t_33); __pyx_t_33 = 0;
      if (__Pyx_PrintOne(0, __pyx_t_32) < 0) __PYX_ERR(0, 57, __pyx_L1_error)
 ...
 */
    ...
    /* "solvers/svd/svd_train_stochastic.pyx":58
 *         if iter % 20 == 0:
 *             print "  max_change %e, eps: %e, resid: %e" % (max_change, eps, total_err)
 *         if abs(old_resid - total_err)/total_err < eps:             # <<<<<<<<<<<<<<
 *             break
 *         old_resid = total_err
 */
    __pyx_t_24 = (((fabs((__pyx_v_old_resid - __pyx_v_total_err)) / __pyx_v_total_err) < __pyx_v_eps) != 0);
    if (__pyx_t_24) {

      /* "solvers/svd/svd_train_stochastic.pyx":59
 *             print "  max_change %e, eps: %e, resid: %e" % (max_change, eps, total_err)
 *         if abs(old_resid - total_err)/total_err < eps:
 *             break             # <<<<<<<<<<<<<<
 *         old_resid = total_err
 ...
 * 
 */
    __pyx_t_24 = ((__pyx_v_iter == __pyx_v_maxiters) != 0);
    if (__pyx_t_24) {
 ...
 *     return iter
 */
      if (__Pyx_PrintOne(0, __pyx_kp_s_Reached_max_iters) < 0) __PYX_ERR(0, 62, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_WriteUnraisable("solvers.svd.svd_train_stochastic._svd_train_sgd", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Reached_max_iters, __pyx_k_Reached_max_iters, sizeof(__pyx_k_Reached_max_iters), 0, 0, 1, 0},
 ...
 *                       int maxiters, double gamma, int include_bias):
 */
  __pyx_tuple__29 = PyTuple_Pack(12, __pyx_n_s_left, __pyx_n_s_right, __pyx_n_s_resid, __pyx_n_s_rand_order, __pyx_n_s_uids, __pyx_n_s_mids, __pyx_n_s_ratings, __pyx_n_s_rate, __pyx_n_s_eps, __pyx_n_s_maxiters, __pyx_n_s_gamma, __pyx_n_s_include_bias); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__29);
  __Pyx_GIVEREF(__pyx_tuple__29);
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(12, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_solvers_svd_svd_train_stochastic, __pyx_n_s_svd_train_sgd, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 11, __pyx_L1_error)
...
#endif
{
  ...
  /* "solvers/svd/svd_train_stochastic.pyx":8
 ...
 *                       int maxiters, double gamma, int include_bias):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7solvers_3svd_20svd_train_stochastic_1svd_train_sgd, NULL, __pyx_n_s_solvers_svd_svd_train_stochastic_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_svd_train_sgd, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
