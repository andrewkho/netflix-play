 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "util/incomplete_projection.pyx":53
 *     cdef int out_row, out_col, k, i
 *     for out_row in range(left_num_rows):
 *         user_cols = csr_indices[csr_indptr[out_row]:csr_indptr[out_row + 1]]             # <<<<<<<<<<<<<<
 *         user_rats = csr_data[csr_indptr[out_row]:csr_indptr[out_row + 1]]
 ...
 */
    __pyx_t_7 = __pyx_v_out_row;
    __pyx_t_8 = (__pyx_v_out_row + 1);
 ...
 *                 rating = user_rats[i]
 */
      __pyx_t_11 = (__pyx_v_user_cols.shape[0]);
 ...
 */
        ...
        __pyx_v_k = (*((int *) ( /* dim=0 */ (__pyx_v_user_cols.data + __pyx_t_13 * __pyx_v_user_cols.strides[0]) )));
 ...
 */
        ...
        __pyx_v_rating = (*((double *) ( /* dim=0 */ (__pyx_v_user_rats.data + __pyx_t_14 * __pyx_v_user_rats.strides[0]) )));
 ...
 */
        ...
        __pyx_v_tot = (__pyx_v_tot + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right.data + __pyx_t_15 * __pyx_v_right.strides[0]) ) + __pyx_t_16 * __pyx_v_right.strides[1]) ))) * __pyx_v_rating));
      }

      /* "util/incomplete_projection.pyx":62
 *                 rating = user_rats[i]
 *                 tot += right[k, out_col] * rating
 *             tot /= user_cols.shape[0]             # <<<<<<<<<<<<<<
 *             out_mat[out_row, out_col] = tot
 * 
 */
      __pyx_v_tot = (__pyx_v_tot / (__pyx_v_user_cols.shape[0]));
 ...
 *     return 0
 */
      __pyx_t_17 = __pyx_v_out_row;
      __pyx_t_18 = __pyx_v_out_col;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out_mat.data + __pyx_t_17 * __pyx_v_out_mat.strides[0]) ) + __pyx_t_18 * __pyx_v_out_mat.strides[1]) )) = __pyx_v_tot;
    }
  }

  /* "util/incomplete_projection.pyx":65
 *             out_mat[out_row, out_col] = tot
 * 
 *     return 0             # <<<<<<<<<<<<<<
 */
