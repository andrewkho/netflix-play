 ...
 */
    ...
    __pyx_t_11 = __pyx_convert_map_from_py_int__and_double(PyList_GET_ITEM(__pyx_v_rating_dicts, __pyx_v_item_col)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 112, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_11 = __pyx_convert_map_from_py_int__and_double(PyList_GET_ITEM(__pyx_v_rating_dicts, __pyx_v_other_col)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L1_error)
 ...
 *             else:
 */
      __pyx_t_33 = ((__pyx_v_ixn_size == 0) != 0);
      if (__pyx_t_33) {
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_out_row.data + __pyx_t_34 * __pyx_v_out_row.strides[0]) )) = __pyx_v_item_col;
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_out_col.data + __pyx_t_35 * __pyx_v_out_col.strides[0]) )) = __pyx_v_other_col;
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_out_data.data + __pyx_t_36 * __pyx_v_out_data.strides[0]) )) = __pyx_v_cov;
